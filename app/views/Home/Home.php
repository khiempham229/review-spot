      ...
      <div class="row row-cols-4">
        <div class="col">
          <div class="card review-card">
            ...
            <div class="card-body">
              <h5 class="card-title truncate">Review sữa rửa mặt Cerave</h5>
              <p class="card-subtitle mb-3 text-body-secondary">Sữa rửa mặt</p>
              <p class="card-text truncate line-clamp-3">Sữa rửa mặt Cerave là sản phẩm làm sạch da được nhiều chuyên gia tin chọn. Để giúp bạn yên tâm sử dụng và biết cách lựa chọn sản phẩm phù hợp, bài viết này sẽ reviews top 5 sữa rửa mặt hàng đầu của Cerave.</p>
              <a href="#" class="btn btn-primary">Đọc Thêm</a>
            </div>
          </div>
        </div>
        <div class="col">
